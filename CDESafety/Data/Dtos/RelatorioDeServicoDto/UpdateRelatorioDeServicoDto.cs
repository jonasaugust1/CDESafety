...
{
    public class UpdateRelatorioDeServicoDto
    {
        ...
        [Required(ErrorMessage = "O campo Cliente de Emissão é obrigatório")]
        public List<Cliente> Clientes { get; set; }

        [Required(ErrorMessage = "O campo Propriedade é obrigatório")]
        public List<Propriedade> Propriedades { get; set; }

        [Required(ErrorMessage = "O campo Pista é obrigatório")]
        public Pista Pista { get; set; }

        [Required(ErrorMessage = "O campo Cultura é obrigatório")]
        ...
        [Required(ErrorMessage = "O campo Piloto é obrigatório")]
